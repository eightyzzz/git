...
static bool eap_at_wait_boot(uint32_t timeout);
...
static at_ack_t esp_at_usart_wait_receive(uint32_t timeout)
{
	rxlen = 0;
	rxline = rxbuf;
	bool acked = xSemaphoreTake(at_ack_semaphore, timeout) == pdPASS;
...
{
//	AT+CWJAP?
//	+CWJAP:"Xiaomi","d4:da:21:6b:2b:d4",11,-55,0,1,3,0,1
...
{
//	AT+HTTPCLIENT=2,1,"https://api.seniverse.com/v3/weather/now.json?key=SLGPI8dHGWDaTC218&location=xiamen&language=en&unit=c",,,2
//	+HTTPCLIENT:264,{"results":[{"location":{"id":"WS7GQBRNR6V8","name":"Xiamen","country":"CN","path":"Xiamen,Xiamen,Fujian,China","timezone":"Asia/Shanghai","timezone_offset":"+08:00"},"now":{"text":"Sunny","code":"0","temperature":"18"},"last_update":"2026-02-21T17:07:24+08:00"}]}
